...
function create_service_file(BRANCH_CONFIG_FILE: any, program_file_name: string, program_name: string) {
    let exec_start = get_config_parametr(BRANCH_CONFIG_FILE, 'exec_param', '')
